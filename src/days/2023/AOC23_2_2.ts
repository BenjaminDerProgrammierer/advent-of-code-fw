...
//         for (let k = 0; k < 3; k++) {
//             if (input[i][j][k] > fewestPossibe[k]) {
//                 fewestPossibe[k] = input[i][j][k]
//             }
//         }
//     }
//     solution += fewestPossibe[0] * fewestPossibe[1] * fewestPossibe[2]
// }
...
// function getInput() {
//     return `Game 1: 1 blue, 1 red; 10 red; 8 red, 1 blue, 1 green; 1 green, 5 blue
