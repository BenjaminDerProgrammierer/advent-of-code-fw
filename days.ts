...
function day_24_1(test) {
  let input = getInput(24, test);
  console.log('Some Day 24_1 info...', input);
  return 'wow';
}

function day_24_2(test) {
  let input = getInput(24, test);
  console.log('Some Day 24_2 info...', input);
  return 'wow';
}
function day_25_1(test) {
  let input = getInput(25, test);
  console.log('Some Day 25_1 info...', input);
  return 'wow';
}

function day_25_2(test) {
  let input = getInput(25, test);
...
function day_28_1(test) {
  let input = getInput(28, test);
  console.log('Some Day 28_1 info...', input);
  return 'wow';
}

function day_28_2(test) {
  let input = getInput(28, test);
...
function day_31_1(test) {
  let input = getInput(31, test);
  console.log('Some Day 31_1 info...', input);
  return 'wow';
}

function day_31_2(test) {
  let input = getInput(31, test);
  console.log('Some Day 31_2 info...', input);
  return 'wow';
}
